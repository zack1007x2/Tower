...
//        Utils.LOGD("_vhandle = " + _vhandle);
        ...
        _ytid = textures[0];
        Log.e("Ray", "glGenTextures Y = " + _ytid);
        GLES20.glGenTextures(1, textures, 0);
        checkGlError("glGenTextures");
        _utid = textures[0];
        Log.e("Ray", "glGenTextures U = " + _utid);
        GLES20.glGenTextures(1, textures, 0);
        checkGlError("glGenTextures");
        _vtid = textures[0];
        Log.e("Ray", "glGenTextures V = " + _vtid);
...
//        Log.e(TAG, "ytid:" + _ytid + ", u=" + _utid + ", v=" + _vtid + ", sizechange: " + videoSizeChanged);
...
//                Utils.LOGE(GLES20.glGetShaderInfoLog(shader), null);
     ...
     */
    ByteBuffer _vertice_buffer, _coord_buffer;
    private void createBuffers(float[] vert, float[] coord) {
        ...
        Log.e(TAG, "vertice buffer create finish");
